  ...
  <div class="auth-page">
    ...
    <div class="left-panel">
      ...
      <div class="left-inner">
        ...
        <div class="hero-text">
          <h2>Quên mật khẩu? 🔒</h2>
          <p>Đừng lo lắng, chúng tôi sẽ giúp bạn lấy lại quyền truy cập tài khoản một cách dễ dàng.</p>
        </div>
        <div class="feature-list">
          <div class="feat">
            <div class="feat-icon"><i class="pi pi-envelope"></i></div>
            <span>Nhận liên kết qua email</span>
          </div>
          <div class="feat">
    ...
    <div class="right-panel">
      <div class="form-card">
        ...
        <div class="form-header">
          <div class="form-icon"><i class="pi pi-key"></i></div>
          <h1>Quên mật khẩu</h1>
